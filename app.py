...
app.config['SQLALCHEMY_DATABASE_URI']='postgresql://postgre:Eyh23894@localhost/HRMS_DB'
db=SQLAlchemy(app)
...
class Candidates(db.Model):
    ...
    def _init_(self, first_name, last_name, identity_number, date_of_birth):
...
class Educations(db.Model):
    ...
    def _init_(self, resume_id, name_of_educational_institution, department, degree, starting_date, graduation_date):
...
class Employers(db.Model):
    ...
    def _init_(self, user_id, company_name, web_address, phone_number):
...
class Experinces(db.Model):
    ...
    def _init_(self, resume_id, job_title_id, company_name, starting_date, termination_date):
        self.resume_id = resume_id
...
class Job_postings(db.Model):
    ...
    def _init_(self, employer_id, job_title_id, job_description, salary_min, salary_max, posting_date, closing_date, isActive):
...
class Resumes(db.Model):
    ...
    def __init__(self, id, candidate_id, creation_date):
...
class Skills(db.Model):
    ...
    def __init__(self, id, resume_id, skill):
        self.resume_id = resume_id
        self.skill = skill
...
class Updated_employers(db.Model):
    ...
    def __init__(self, id, employer_id, email, password, company_name, web_address, phone_number):
        self.employer_id=employer_id
        self.email = email
